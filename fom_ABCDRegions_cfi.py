cutsRegionA = {
               ...
               #'Base' : 'isRegionA_Z',
               'ptTopHiggs' : 'isRegionA&&((ptTopTagged0M[0]-ptHTagged1M0L[0])/mtprimeATilde_tM_ZB)<0.1',
               ...
               '1200MassRegion10p' : 'isRegionA && mtprimeATilde_tM_ZB > (1200-1200*0.15) && mtprimeATilde_tM_ZB < (1200+1200*0.15) && ptHTagged1M0L>350',
               '600MassRegion10p' : 'isRegionA && mtprimeATilde_tM_ZB > (1100-1100*0.15) && mtprimeATilde_tM_ZB < (1100+1100*0.15)',
               '1800MassRegion10p' : 'isRegionA && mtprimeATilde_tM_ZB > (1800-1800*0.15) && mtprimeATilde_tM_ZB < (1800+1800*0.15)',
              }
cutsRegionB = {
               #'Base' : 'isRegionB_tM_ZB && !(ZAnul[7])',
               'Base' : 'isRegionB_tM_ZB',
               #'Base' : 'isRegionB_Z',
               'ptTopHiggs' : 'isRegionB&&((ptTopTaggedM[0]-ptHTagged1M0L[0])/mtprimeBTilde_tM_ZB)<0.1',
               ...
               '1200MassRegion10p' : 'isRegionB && mtprimeBTilde_tM_ZB > (1200-1200*0.15) && mtprimeBTilde_tM_ZB < (1200+1200*0.15) && ptHTagged1M0L>350',
               '600MassRegion10p' : 'isRegionB && mtprimeBTilde_tM_ZB > (1100-1100*0.15) && mtprimeBTilde_tM_ZB < (1100+1100*0.15)',
               '1800MassRegion10p' : 'isRegionB && mtprimeBTilde_tM_ZB > (1800-1800*0.15) && mtprimeBTilde_tM_ZB < (1800+1800*0.15)',
              }
cutsRegionC = {
               'Base' : 'isRegionC_tM_ZB && !(ZAnul[2])',
               #'Base' : 'isRegionC_tM_ZB',
               #'Base' : 'isRegionC_Z',
               'ptTopHiggs' : 'isRegionC && !(ZAnul[7])&&((ptTopTagged0M[0]-ptHTagged1M1L[0])/mtprimeCTilde_tM_ZB)<0.1',
               'Base2' : 'isRegionC && !(ZAnul[7]) && ptHTagged1M1L>400',
               'cosThetaStar' : 'isRegionC && abs(costheta(ptHTagged1M1L,etaHTagged1M1L,phiHTagged1M1L,MHTagged1M1L,ptTopTagged0M,etaTopTagged0M,phiTopTagged0M,MTopTagged0M))<0.9&&!(ZAnul[7])',
               '1200MassRegion10p' : 'isRegionC && mtprimeCTilde_tM_ZB > (1200-1200*0.15) && mtprimeCTilde_tM_ZB < (1200+1200*0.15) && ptHTagged1M1L>350',
               '600MassRegion10p' : 'isRegionC && mtprimeCTilde_tM_ZB > (1100-1100*0.15) && mtprimeCTilde_tM_ZB < (1100+1100*0.15)',
               '1800MassRegion10p' : 'isRegionC && mtprimeCTilde_tM_ZB > (1800-1800*0.15) && mtprimeCTilde_tM_ZB < (1800+1800*0.15)',
              }
cutsRegionD = { 
               'Base' : 'isRegionD_tM_ZB && !(ZAnul[2])', 
               #'Base' : 'isRegionD_tM_ZB', 
               #'Base' : 'isRegionD_Z', 
               'ptTopHiggs' : 'isRegionD && !(ZAnul[7])&&((ptTopTaggedM[0]-ptHTagged1M1L[0])/mtprimeDTilde_tM_ZB)<0.1', 
               'Base2' : 'isRegionD && !(ZAnul[7]) && ptHTagged1M1L>400', 
               'cosThetaStar' : 'isRegionD&&abs(costheta(ptHTagged1M1L[0],etaHTagged1M1L[0],phiHTagged1M1L[0],MHTagged1M1L[0],ptTopTaggedM[0],etaTopTaggedM[0],phiTopTaggedM[0],MTopTaggedM[0]))<0.9&&!(ZAnul[7])',
               #'cosThetaStar' : 'isRegionD&&abs(costheta(ptHTagged1M1L,etaHTagged1M1L,phiHTagged1M1L,MHTagged1M1L,ptTopTaggedM,etaTopTaggedM,phiTopTaggedM,MTopTaggedM))<0.9&&!(ZAnul[7])',
               '1200MassRegion10p' : 'isRegionD && mtprimeDTilde_tM_ZB > (1200-1200*0.15) && mtprimeDTilde_tM_ZB < (1200+1200*0.15) && !(ZAnul[7]) && ptHTagged1M1L>350',
               '600MassRegion10p' : 'isRegionD && mtprimeDTilde_tM_ZB > (1100-1100*0.15) && mtprimeDTilde_tM_ZB < (1100+1100*0.15) && !(ZAnul[7])',
               '1800MassRegion10p' : 'isRegionD && mtprimeDTilde_tM_ZB > (1800-1800*0.15) && mtprimeDTilde_tM_ZB < (1800+1800*0.15) && !(ZAnul[7])',
             } 
...
additionalCuts = {
                  ...
                  'massWindow_topM_ZB_norm' : '&& (ptAK8[0]+ptAK8[1])>850 && @ptExtraAK4.size()>1 && Sum$(abs(etaExtraAK4)>2.4)>0',
                  'massWindow_topM_ZB_withData_extraJetVeto' : '&& (ptAK8[0]+ptAK8[1])>850 && !(@ptExtraAK4.size()>1 && Sum$(abs(etaExtraAK4)>2.4)>0)',
                  'massWindow_topM_ZB_withData_forwardVeto' : '&& (ptAK8[0]+ptAK8[1])>850 && Sum$(abs(etaAK4)>2.4)==0',
