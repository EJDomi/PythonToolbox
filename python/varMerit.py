    ...
    for cut in cutList:
        ...
        if sigType is 'H':
            if not is2015:
                ...
                #    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['800MassRegion'] + cutList[cut] 
                #    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['800MassRegion'] + cutList[cut] 
                #    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['800MassRegion'] + cutList[cut] 
                #    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['800MassRegion'] + cutList[cut]
                #elif '900MassRegion' in cut:
                #    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['900MassRegion'] + cutList[cut] 
                #    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['900MassRegion'] + cutList[cut] 
                #    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['900MassRegion'] + cutList[cut] 
                #    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['900MassRegion'] + cutList[cut]
                if '1100MassRegion' in cut:
                    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['1100MassRegion10p'] + cutList[cut] 
                    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['1100MassRegion10p'] + cutList[cut] 
                    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['1100MassRegion10p'] + cutList[cut] 
                    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['1100MassRegion10p'] + cutList[cut]
                elif '1200MassRegion' in cut:
                    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['1200MassRegion10p'] + cutList[cut] 
                    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['1200MassRegion10p'] + cutList[cut] 
                    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['1200MassRegion10p'] + cutList[cut] 
                    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['1200MassRegion10p'] + cutList[cut]
                elif '1800MassRegion' in cut:
                    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['1800MassRegion10p'] + cutList[cut] 
                    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['1800MassRegion10p'] + cutList[cut] 
                    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['1800MassRegion10p'] + cutList[cut] 
                    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['1800MassRegion10p'] + cutList[cut]
                else:
                    isRegionA_FOM['mtprimeATilde_tM_ZB']['Cuts'] = cutsRegionA['Base'] + cutList[cut] 
                    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts'] = cutsRegionB['Base'] + cutList[cut]
                    
                    print isRegionB_FOM['mtprimeBTilde_tM_ZB']['Cuts']  
                    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Cuts'] = cutsRegionC['Base'] + cutList[cut] 
                    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Cuts'] = cutsRegionD['Base'] + cutList[cut]
                if 'HT' in QCDType:
                    isRegionA_FOM['mtprimeATilde_tM_ZB']['Wts'] += '*WeightSumPt(ptAK8[0],ptAK8[1],0)' 
                    isRegionB_FOM['mtprimeBTilde_tM_ZB']['Wts'] += '*WeightSumPt(ptAK8[0],ptAK8[1],0)' 
                    isRegionC_FOM['mtprimeCTilde_tM_ZB']['Wts'] += '*WeightSumPt(ptAK8[0],ptAK8[1],0)' 
                    isRegionD_FOM['mtprimeDTilde_tM_ZB']['Wts'] += '*WeightSumPt(ptAK8[0],ptAK8[1],0)'
