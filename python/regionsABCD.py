...
def makeTables(RegionA, RegionB, RegionC, RegionD, outFileName, doubleRatioFile, syst=0.1):
    ...
    with open(outFileName,'w') as f:
        ...
        for key in sorted(cutANum):
            spacing = ' ' * (18-len(key))
            if 'Data' in key:
                f.write(' '+str(key)+spacing+'& $'+str(TradRound(cutANum[key]))+'$'+' ' * (20-len(str(TradRound(cutANum[key]))))+'& $'+str(TradRound(cutBNum[key]))+'$'+' ' * (20-len(str(TradRound(cutBNum[key]))))+'& $'+str(TradRound(cutCNum[key]))+'$'+' ' * (20-len(str(TradRound(cutBNum[key]))))+'& $'+str(TradRound(cutDNum[key]))+ ' \pm ' +str(TradRound(cutDNumErr[key]))+'$'+' \\\\ \n')
                #f.write(' '+str(key)+spacing+str(TradRound(cutANum[key]))+' ' * (20-len(str(TradRound(cutANum[key]))))+str(TradRound(cutBNum[key]))+' ' * (20-len(str(TradRound(cutBNum[key]))))+str(TradRound(cutCNum[key]))+' ' * (20-len(str(TradRound(cutBNum[key]))))+'\n')
            elif 'data' in key:
                f.write(' '+str(key)+spacing+'& $'+str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))))+'& $'+str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))))+'& $'+str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))))+ ' '+'& $'+str(TradRound(cutDNum[key]))+ ' \pm ' +str(TradRound(cutDNumErr[key]))+'$'+' \\\\ \n')
                #f.write(' '+str(key)+spacing+str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))+' ' * (20-len(str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))))+str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))+' ' * (20-len(str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))))+str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))+' ' * (20-len(str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))))+'\n')
            else:
                f.write(' '+str(key)+spacing+'& $'+str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutANum[key]))+ ' \pm '+ str(TradRound(cutANumErr[key]))))+'& $'+str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutBNum[key])) +' \pm '+ str(TradRound(cutBNumErr[key]))))+'& $'+str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))+'$'+' ' * (20-len(str(TradRound(cutCNum[key])) + ' \pm ' +str(TradRound(cutCNumErr[key]))))+'& $'+str(TradRound(cutDNum[key]))+ ' \pm ' +str(TradRound(cutDNumErr[key]))+'$'+' \\\\ \n')
