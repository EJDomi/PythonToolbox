    ...
    with open(outFileName,'w') as f:
        ...
        for key in sorted(cutANum):
            ...
            if 'Data' in key:
                ...
                f.write(' '+str(key)+spacing+str(TradRound(cutANum[key]))+ ' +/- '+ str(TradRound(cutANumErr[key]))+' ' * (30-len(str(TradRound(cutANum[key]))+ ' +/- '+ str(TradRound(cutANumErr[key]))))+str(TradRound(cutBNum[key])) +' +/- '+ str(TradRound(cutBNumErr[key]))+' ' * (30-len(str(TradRound(cutBNum[key])) +' +/- '+ str(TradRound(cutBNumErr[key]))))+str(TradRound(cutCNum[key])) + ' +/- ' +str(TradRound(cutCNumErr[key]))+' ' * (30-len(str(TradRound(cutCNum[key])) + ' +/- ' +str(TradRound(cutCNumErr[key]))))+'\n')
            else:
                f.write(' '+str(key)+spacing+str(TradRound(cutANum[key]))+ ' +/- '+ str(TradRound(cutANumErr[key]))+' ' * (30-len(str(TradRound(cutANum[key]))+ ' +/- '+ str(TradRound(cutANumErr[key]))))+str(TradRound(cutBNum[key])) +' +/- '+ str(TradRound(cutBNumErr[key]))+' ' * (30-len(str(TradRound(cutBNum[key])) +' +/- '+ str(TradRound(cutBNumErr[key]))))+str(TradRound(cutCNum[key])) + ' +/- ' +str(TradRound(cutCNumErr[key]))+' ' * (30-len(str(TradRound(cutCNum[key])) + ' +/- ' +str(TradRound(cutCNumErr[key]))))+str(TradRound(cutDNum[key]))+ ' +/- ' +str(TradRound(cutDNumErr[key]))+'\n')
        f.write(' '+'estQCD'+(' '*(18-len('estQCD')))+str(TradRound(cutDNum['estQCD']))+ ' +/- ' +str(TradRound(cutDNumErr['estQCD']))+'\n')
        f.write(' '+'estBackground'+(' '*(18-len('EstBackground')))+str(TradRound(cutDNum['EstBackground']))+ ' +/- ' +str(TradRound(cutDNumErr['EstBackground']))+'\n\n')

        for key in ratios:
            f.write(key+'\n')
            for ratio in ratios[key]:
                f.write(' '+ratio+ ': ' + str(TradRound(ratios[key][ratio])) + ' +/- ' + str(TradRound(ratiosErr[key][ratio])) + '\n')
        f.close()
